...
export default function NovaDemandaPage() {
  ...
  const [iaAberto, setIaAberto] = useState(() => searchParams.get('ia') === '1')
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <div className="mb-4">
        <Link href="/nova-demanda" className="inline-flex items-center gap-1 text-sm text-stone-400 hover:text-stone-700 mb-3">
          ← Voltar
        </Link>
